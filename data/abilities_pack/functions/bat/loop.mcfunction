...
execute unless predicate abilities_pack:is_bright run effect clear @s blindness
execute if predicate abilities_pack:is_bright run effect give @s blindness 20 0 true
