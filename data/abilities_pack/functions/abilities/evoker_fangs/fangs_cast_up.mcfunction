...
#call again
execute unless entity @e[type=evoker_fangs,tag=new] if score #abilities_pack apvar_0 <= @s apvar_0 positioned ~ ~1 ~ run function abilities_pack:abilities/evoker_fangs/fangs_cast_up
