...
#target_id
execute as @e[type=!minecraft:area_effect_cloud,distance=0] unless score @s target_id matches ..2147483647 run function abilities_pack:abilities/assign_target_id
