...
#call again
execute unless entity @e[tag=shulker_target] if score @s ray_range matches 1.. positioned ^ ^ ^0.5 run function abilities_pack:abilities/shoot_shulker_bullet/raycast
