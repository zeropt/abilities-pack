...
#call again
execute unless entity @e[tag=shulker_target] if score #global temp_global matches 1.. positioned ^ ^ ^0.5 run function abilities_pack:abilities/shoot_shulker_bullet/raycast
