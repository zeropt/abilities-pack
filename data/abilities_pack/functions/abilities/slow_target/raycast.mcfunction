...
#call again
execute unless entity @e[tag=slow_target] if score #global temp_global matches 1.. if block ~ ~ ~ air positioned ^ ^ ^0.5 run function abilities_pack:abilities/slow_target/raycast
