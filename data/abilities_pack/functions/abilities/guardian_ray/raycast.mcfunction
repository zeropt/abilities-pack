...
#call again
execute unless entity @e[tag=guardian_target] if score #abilities_pack apvar_0 matches 1.. if block ~ ~ ~ #abilities_pack:laser_passable positioned ^ ^ ^0.5 run function abilities_pack:abilities/guardian_ray/raycast
