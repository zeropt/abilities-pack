...
#call again
execute unless entity @e[tag=guardian_target] if score #global temp_global matches 1.. if block ~ ~ ~ #abilities_pack:nonsolid positioned ^ ^ ^0.5 run function abilities_pack:abilities/guardian_ray/raycast
