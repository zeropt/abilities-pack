...
#spells
execute as @s[tag=trigger_act] unless predicate abilities_pack:see_blue_sheep unless predicate abilities_pack:is_sneaking run function abilities_pack:abilities/evoker_fangs/line_spell
execute as @s[tag=trigger_act] unless predicate abilities_pack:see_blue_sheep if predicate abilities_pack:is_sneaking run function abilities_pack:abilities/evoker_fangs/ring_spell
