...
execute at @s facing entity @e[type=minecraft:armor_stand,tag=direction,limit=1,sort=nearest] feet positioned ^ ^ ^2 run function abilities_pack:traits/arrow_raycast
