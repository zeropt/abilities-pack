...
#summon cloud
execute as @e[type=!#abilities_pack:undead,distance=0] run summon area_effect_cloud ~ ~ ~ {Radius:0.5f,Duration:6,Tags:["new_cloud"],Effects:[{Id:7b}]}
execute as @e[type=#abilities_pack:undead,tag=!new_cloud,distance=0] run summon area_effect_cloud ~ ~ ~ {Radius:0.5f,Duration:6,Tags:["new_cloud"],Effects:[{Id:6b}]}
