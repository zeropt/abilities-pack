...
give @s[scores={act_id=0}] warped_fungus_on_a_stick{display:{Name:'{"text":"Shulker Bullet","color":"light_purple"}',Lore:['{"text":"Shift for shulker shell"}']},CustomModelData:11804,activator:1b} 1
