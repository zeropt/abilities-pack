# Give player the test activator
# As: Player
...
execute as @s[scores={act_target=1..}] run give @s warped_fungus_on_a_stick{display:{Name:'{"text":"Test!"}'},CustomModelData:0,activator:1b} 1
