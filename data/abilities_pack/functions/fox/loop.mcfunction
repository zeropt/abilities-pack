...
execute if predicate abilities_pack:is_in_overworld unless predicate abilities_pack:is_dim run effect give @s weakness 1 0 true
execute if predicate abilities_pack:is_in_overworld unless predicate abilities_pack:is_dim run effect give @s hunger 1 2 true
